...
const vi: Dict = {
  ...
  'hero.sub':
    'Hơn 150 gian hàng trong 4 khu vực dưới chân Cầu Rồng. Hải sản tươi, mì Quảng, bánh tráng nướng, kem bơ — và đèn lồng sáng từ 18:30 mỗi đêm.',
  ...
  'stats.note': 'Khảo sát của ban quản lý chợ và Tripadvisor — cập nhật tháng 5/2026.',
  ...
  'gallery.4': 'Không khí đêm Đà Nẵng',

  // Dishes (editorial cards)
  'dishes.section': 'III · ẨM THỰC',
  'dishes.title': '8 món phải thử',
  'dishes.sub':
    'Tinh hoa miền Trung trong một đêm — từ bánh tráng nướng 15k đến hải sản nướng late-night. Giá tham khảo cập nhật 2025.',
  ...
  'dish.1.desc': 'Bánh tráng nướng trứng + ruốc + pate trên than hoa — street food kinh điển của chợ đêm Đà Nẵng.',
  'dish.1.price': '10 – 15k',
  ...
  'dish.3.desc': 'Vỏ giòn rụm vàng nghệ, nhân tôm thịt & giá đỗ, ăn cùng rau rừng và nước mắm chua ngọt.',
  'dish.3.price': '35 – 50k',
  'dish.3.tag': 'Crispy crepe',
  'dish.4.name': 'Bánh bèo chén',
  'dish.4.desc': 'Bánh bèo trắng mềm trong chén nhỏ, tôm cháy, hành phi, nước mắm chua ngọt — đậm chất Huế – Đà Nẵng.',
  'dish.4.price': '25 – 40k',
  ...
  'dish.6.desc': 'Tôm sú, cua, ghẹ, sò điệp, mực — chọn tươi tại quầy, nướng than hoa hoặc hấp sả ngay.',
  'dish.6.price': '100 – 800k',
  'dish.6.tag': 'Seafood',
  'dish.7.name': 'Kem bơ Đà Nẵng',
  'dish.7.desc': 'Bơ sáp xay nhuyễn, kem dừa, đậu phộng — món tráng miệng huyền thoại của Đà Nẵng.',
  'dish.7.price': '10 – 25k',
  'dish.7.tag': 'Dessert',
  ...
  'tips.sub':
    'Lời nhắn của những người Đà Nẵng đã đi chợ này quá nhiều lần — tổng hợp từ Facebook fanpage, comment review Tripadvisor, và một buổi tối ngồi cà phê với hai tiểu thương.',
...
const en: Dict = {
  ...
  'hero.sub':
    'Over 150 stalls across 4 zones at the foot of Dragon Bridge. Fresh seafood, mì Quảng, grilled rice paper, avocado ice cream — and lanterns lit from 18:30 every night.',
  ...
  'stats.note': 'Sourced from market management surveys and Tripadvisor — updated May 2026.',
  ...
  'gallery.4': "An ordinary Đà Nẵng night",
  ...
  'tips.sub':
    "Notes from Đà Nẵng locals who've been here too many times — pulled from the Facebook fanpage, Tripadvisor comments, and one evening of coffee with two vendors.",
